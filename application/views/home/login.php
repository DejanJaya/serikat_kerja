...
<head>
	...
	<title>Login - Sistem Serikat Kerja</title>
						...
						<div class="col-lg-5">
							<div class="card shadow-lg border-0 rounded-lg mt-5">
								<div class="card-header">
									<!-- <h2 class="text-center font-weight-light my-4">Sistem Serikat Kerja</h2> -->
									<img style="display: block;margin-left: auto;margin-right: auto; height:96px; width:120px;" src="<?php echo base_url() ?>assets/template/dist/img/logo_sptj.png">
									<h2 class="text-center font-weight-light my-4">Sistem Serikat Kerja</h2>
