<nav style="background-color: #000080;" class="sb-topnav navbar navbar-expand navbar-dark">
	<!-- <a class="navbar-brand" href="">Sistem Serikat Kerja

	</a> -->
	<a style="text-decoration: none;" href="" class="brand-link">
		<img style="width:32px;" src="<?php echo base_url() ?>assets/template/dist/img/logo_sptj.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
		<span style="color: white;font-size:17px;margin-right: 10px;" class="brand-text font-weight-light">Sistem Serikat Kerja</span>
	</a>
...
<div id="layoutSidenav">
	<div id="layoutSidenav_nav">
		<nav style="background-color: #1E90FF;" class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
			<div class="sb-sidenav-menu">
				<?php if ($this->session->userdata('admin')) {  ?>
					<div class="nav">
						...
						<div style="color: white;" class="sb-sidenav-menu-heading">Addons</div>
						...
						<div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="<?= base_url('admin/pengguna/anggota') ?>">Anggota</a>
				...
				<?php  } else { ?>
					<div class="nav">
						...
						<a class="nav-link" href="<?= base_url('pengguna/hak_kewajiban') ?>">
							<div class="sb-nav-link-icon"><i class="fas fa-book"></i></div>
							Hak dan Kewajiban
						</a>
						<div style="color: white;" class="sb-sidenav-menu-heading">Menu</div>
